...
{ id:'case7-accident', sys:'mixed', tier:0, t:'The Car Accident case study (case 7)', crit:'Module 2 case', flag:'R',
  ...
  hlUrl:'https://canvas.manukau.ac.nz/courses/61986/discussion_topics/413338',
...
{ id:'ns-action-potential', sys:'ns', tier:2, t:'Action potentials', crit:'NS 3', flag:'',
  ...
  cap:'Lifted out of the bottom tier on 16 Sep: the neuron Kahoot drills the ion directions repeatedly, so her Canvas bank under-rates it. Almost entirely True/False and confined to two quizzes. Her traps are direction reversals, so read every one slowly.' },
...
{ id:'ns-neuron', sys:'ns', tier:2, t:'Neuron structure', crit:'NS 3', flag:'D',
  ...
  cap:'Lifted out of the bottom tier on 16 Sep: an entire 20-question Kahoot is "THE NEURON", and "Neuron: parts and functions" is on her diagrams row, so her Canvas bank under-rates it. Low bank density, explicitly named by her — learn the labelled diagram, not the cell biology.' },
